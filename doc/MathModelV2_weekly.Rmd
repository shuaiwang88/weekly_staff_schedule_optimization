...
### Employee
 ...
 4. **$EmployeeShiftMap_{e,d,sh}$**: binary. employee availaibility for shift sh on day d.                           
 
 5. **$EmployeeMax/MinHour_{e}$**: max/min hours per week of for each employee      
 
 6. **$EmployeeCost_{e}$**: cost of each employee               
