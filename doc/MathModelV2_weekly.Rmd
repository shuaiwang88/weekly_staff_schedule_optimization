...
$$\sum_{e} Assign_{e,l,d,sh,sk} \leq 1, \forall  \text{ l, d, sh, sk}$$

3. Employee's weekly hour limit
$$\sum_{l}\sum_{d}\sum_{sh}\sum_{sk} Assign_{e,l,d,sh,sk} * ShiftLen_{l,sh} \leq EmployeeMaxHour_e, \forall  \text{ e}$$
